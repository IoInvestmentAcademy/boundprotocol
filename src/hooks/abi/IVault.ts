export const IVault = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_protocolFeeReserve", type: "address" },
      { internalType: "address", name: "_protocolFeeTracker", type: "address" },
      { internalType: "address", name: "_mlnToken", type: "address" },
      { internalType: "address", name: "_mlnBurner", type: "address" },
      { internalType: "address", name: "_wethToken", type: "address" },
      { internalType: "uint256", name: "_positionsLimit", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_mlnValue", type: "uint256" },
      { internalType: "uint256", name: "_gav", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "bool", name: "canManageAssets_", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [{ internalType: "address", name: "_who", type: "address" }],
    name: "canRelayCalls",
    outputs: [{ internalType: "bool", name: "canRelayCalls_", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "getMlnBurner",
    outputs: [{ internalType: "address", name: "mlnBurner_", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "getMlnToken",
    outputs: [{ internalType: "address", name: "mlnToken_", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "nominatedOwner_", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "positionsLimit_", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "protocolFeeReserve_", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address[]", name: "trackedAssets_", type: "address[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [],
    name: "getWethToken",
    outputs: [{ internalType: "address", name: "wethToken_", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "address", name: "_externalPosition", type: "address" },
    ],
    name: "isActiveExternalPosition",
    outputs: [
      { internalType: "bool", name: "isActiveExternalPosition_", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "address", name: "_who", type: "address" }],
    name: "isAssetManager",
    outputs: [{ internalType: "bool", name: "isAssetManager_", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "address", name: "_nextAccessor", type: "address" },
    ],
    name: "setAccessor",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_nextMigrator", type: "address" },
    ],
    name: "setMigrator",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "string", name: "_nextName", type: "string" }],
    name: "setName",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "_nextNominatedOwner", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "string", name: "_nextSymbol", type: "string" }],
    name: "setSymbol",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "address", name: "_nextVaultLib", type: "address" },
    ],
    name: "setVaultLib",
    outputs: [],
    stateMutability: "nonpayable",
