  ...
  const challenges = [
    {
      ...
      description:
        "Steep learning curves and complex tools make on-chain investing overwhelming.",
      icon: "red",
    },
    {
      title: "Risky Without Expertise",
      description:
        "Accessing on-chain financial products safely requires deep expertise.",
      icon: "red",
    },
    {
      title: "Takes Too Much Time",
      description:
        "Managing strategies, monitoring rates, and rebalancing require ongoing involvement.",
      icon: "red",
    },
  ];
  ...
  const solutions = [
    {
      title: "Easy Access",
      description:
        "One-tap access to a diversified basket of professionally managed on-chain strategies.",
      icon: "green",
    },
    {
      title: "Passive Exposure",
      description:
        "A professional, end-to-end approach designed to deliver passive returns without effort.",
      icon: "green",
    },
    {
      title: "You Stay in Control",
      description:
        "Enjoy full transparency and complete control over your funds at all times.",
      icon: "green",
    },
  ];
