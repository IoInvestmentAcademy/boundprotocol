...
import { getRpcUrlForChain } from "@/hooks/useVaultPrice";
...
export function BuyToken({
  ...
  const updateEnzymeBalance = async () => {
    ...
    try {
      ...
      setEnzymeTokenBalance(formatUnits(balance, 18));
    } catch (error) {
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                Mint Bound USD
                <p className="text-sm text-gray-500">Whitelist Only</p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {vaultPrice && (
                <div className="rounded-xl border border-gray-200 p-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 font-semibold">
                      {Number(1).toFixed(6)} {denominationAssetName}
                    </span>
                  </div>
                </div>
              )}
              ...
              <p className="text-xs text-gray-700">
                <span className="font-semibold">
                  <span className="text-gray-700">Whitelist Only</span>
                </span>
              </p>
            </div>
            ...
            <div className="text-xs text-gray-500 space-y-1">
              <p className="flex items-center space-x-1">
                ...
                <span>
                  Direct minting is available only to whitelisted investors.
                </span>
              </p>
